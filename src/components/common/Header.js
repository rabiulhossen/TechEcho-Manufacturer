...
{/*     ------  large screen end   ------    */}
  ...
  {/* profile dropdown under */}
              ...
              { user &&
              <label htmlFor="dash-sidebar" className=" btn-primary 
              rounded
              sm:block
              z-50
              mr-16
              drawer-button lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
